...
function update() {
  ...
  router.put(`/customers/update/${props.customer.id}`, form.value, {
    onError: (errors) => {
      // Errors will be handled by the server-side validation
  ...
  <div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
      <form @submit.prevent="update" class="space-y-6">
        ...
        <div class="w-1/2">
          <label for="edit-credit-limit" class="block text-sm font-medium text-gray-700 mb-1">Credit Limit (Rs.)</label>
          <input
